...
class DiscordTriviaError extends Error {
    constructor(message, header) {
        if (typeof message != "string")
            throw new DiscordTriviaError(`Expected a string for 'message', recieved ${typeof message}`, "INVALID_CONSTRUCTOR_ARGUMENT");
        if (typeof header != "string")
            throw new DiscordTriviaError(`Expected a string for 'header', recieved ${typeof header}`, "INVALID_CONSTRUCTOR_ARGUMENT");
        super(message);
